...
big_image = images[big_index]
a = []
for i in range(big_image.shape[0]):
    aa = big_image[i][:small].tolist()
    a.append(aa)
...
images[big_index] = torch.tensor(a)

print('*******************')
print(images[big_index].shape)

imageA = images[0].reshape(1, -1)
imageB = images[1].reshape(1, -1)
