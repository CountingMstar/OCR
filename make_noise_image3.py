...
for i in range(data_len):
    ...
    img = cv2.imread('data/original_text/text_image' + str(i) + '.png')
    # plt.imshow(img)
    # cv2.imshow(img)
    ...
    # Load the image
    image_path = "data/original_text/text_image" + str(i) + ".png"  # Replace with the path to your image
    ...
    noisy_image.save("data/noise_text/noise_image" + str(i) + ".png")
    # noisy_image.show()
